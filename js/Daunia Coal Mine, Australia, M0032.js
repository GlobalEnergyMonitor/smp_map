  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-22.079498, 148.291669], 12.0)                     
	...
	GEMMine.bindTooltip('Daunia Coal Mine', { permanent: true, direction: 'right'});
