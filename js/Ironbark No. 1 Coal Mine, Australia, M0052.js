  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-21.85413031, 148.09953255], 12.0)                     
	...
	GEMMine.bindTooltip('Ironbark No. 1 Coal Mine', { permanent: true, direction: 'right'});
