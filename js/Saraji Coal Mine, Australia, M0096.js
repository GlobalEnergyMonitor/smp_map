  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-22.4440915, 148.3161645], 10)                     
	...
	GEMMine.bindPopup('Saraji Coal Mine Operating mine');
	GEMMine.bindTooltip('Saraji Coal Mine Operating mine', { permanent: true, direction: 'right'});
