  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([35.955387, 112.92499], 10)                     
	...
	GEMMine.bindPopup('Yaozhida Coal Mine Operating mine');
	GEMMine.bindTooltip('Yaozhida Coal Mine Operating mine', { permanent: true, direction: 'right'});
