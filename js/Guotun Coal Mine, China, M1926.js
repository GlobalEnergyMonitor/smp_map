  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([35.517552499999994, 115.9431605], 12.0)                     
	...
	GEMMine.bindTooltip('Guotun Coal Mine', { permanent: true, direction: 'right'});
