  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([39.671225, 118.39442650000001], 12.0)                     
	...
	GEMMine.bindTooltip('Lvjiatuo Coal Mine', { permanent: true, direction: 'right'});
