  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.1458495, 111.64952550000001], 12.0)                     
	...
	GEMMine.bindTooltip('Gaoyang Coal Mine', { permanent: true, direction: 'right'});
