  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.8187335, 112.3357745], 12.0)                     
	...
	GEMMine.bindTooltip('Duerping Coal Mine', { permanent: true, direction: 'right'});
