  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.9470605, 112.1291265], 12.0)                     
	...
	GEMMine.bindTooltip('Xiqu Coal Mine', { permanent: true, direction: 'right'});
