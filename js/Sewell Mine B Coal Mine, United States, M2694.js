  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.517551, -81.6323465], 12.0)                     
	...
	GEMMine.bindTooltip('Sewell Mine B Coal Mine', { permanent: true, direction: 'right'});
