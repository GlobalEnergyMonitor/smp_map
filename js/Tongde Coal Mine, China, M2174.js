  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.412595, 110.89058], 12)                     
	...
	GEMMine.bindPopup('Tongde Coal Mine Operating mine');
	GEMMine.bindTooltip('Tongde Coal Mine Operating mine', { permanent: true, direction: 'right'});
