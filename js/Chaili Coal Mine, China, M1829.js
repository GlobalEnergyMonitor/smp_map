  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([34.950816, 117.0286265], 12.0)                     
	...
	GEMMine.bindTooltip('Chaili Coal Mine', { permanent: true, direction: 'right'});
