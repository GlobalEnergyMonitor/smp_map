  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([36.7595695, 113.1065145], 12.0)                     
	...
	GEMMine.bindTooltip('Wangjiayu Coal Mine', { permanent: true, direction: 'right'});
