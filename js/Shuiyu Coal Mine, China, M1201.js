  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.0735595, 111.6572335], 12.0)                     
	...
	GEMMine.bindTooltip('Shuiyu Coal Mine', { permanent: true, direction: 'right'});
