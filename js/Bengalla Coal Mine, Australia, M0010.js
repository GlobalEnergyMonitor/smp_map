  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-32.275229, 150.8169935], 12.0)                     
	...
	GEMMine.bindTooltip('Bengalla Coal Mine', { permanent: true, direction: 'right'});
