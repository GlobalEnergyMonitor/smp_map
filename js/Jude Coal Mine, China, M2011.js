  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.526540499999996, 110.86182450000001], 12.0)                     
	...
	GEMMine.bindTooltip('Jude Coal Mine', { permanent: true, direction: 'right'});
