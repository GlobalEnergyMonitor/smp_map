  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.781361000000004, -81.50452949999999], 12)                     
	...
	GEMMine.bindPopup('Eagle #3 Coal Mine Operating mine');
	GEMMine.bindTooltip('Eagle #3 Coal Mine Operating mine', { permanent: true, direction: 'right'});
