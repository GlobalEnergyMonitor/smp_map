  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.7861425, -81.9478215], 12.0)                     
	...
	GEMMine.bindTooltip('Lynn Branch No. 2 Coal Mine', { permanent: true, direction: 'right'});
