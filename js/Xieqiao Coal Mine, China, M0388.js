  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([32.7849055, 116.390762], 12.0)                     
	...
	GEMMine.bindTooltip('Xieqiao Coal Mine', { permanent: true, direction: 'right'});
