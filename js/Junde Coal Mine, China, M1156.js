  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([47.214811499999996, 130.21832849999998], 12.0)                     
	...
	GEMMine.bindTooltip('Junde Coal Mine', { permanent: true, direction: 'right'});
