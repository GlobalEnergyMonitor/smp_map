  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-24.6666805, 149.995723], 10)                     
	...
	GEMMine.bindPopup('Dawson Complex Operating mine');
	GEMMine.bindTooltip('Dawson Complex Operating mine', { permanent: true, direction: 'right'});
