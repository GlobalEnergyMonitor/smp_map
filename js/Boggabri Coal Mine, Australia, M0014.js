  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-30.604599, 150.151337], 12.0)                     
	...
	GEMMine.bindTooltip('Boggabri Coal Mine', { permanent: true, direction: 'right'});
