  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([51.404478999999995, 94.2595975], 10)                     
	...
	GEMMine.bindPopup('Mezhegeyugol Coal Mine Operating mine');
	GEMMine.bindTooltip('Mezhegeyugol Coal Mine Operating mine', { permanent: true, direction: 'right'});
	GEMMine = L.marker([51.391967, 94.110944], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Mezhegeyugol Coal Mine Cancelled mine');
	GEMMine.bindTooltip('Mezhegeyugol Coal Mine Cancelled mine', { permanent: true, direction: 'right'});
