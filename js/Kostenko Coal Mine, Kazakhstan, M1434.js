  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([49.848005, 73.130741], 12.0)                     
	...
	GEMMine.bindTooltip('Kostenko Coal Mine', { permanent: true, direction: 'right'});
