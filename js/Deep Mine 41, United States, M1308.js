  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.074281, -82.3790295], 10)                     
	...
	GEMMine.bindPopup('Deep Mine 41 Operating mine');
	GEMMine.bindTooltip('Deep Mine 41 Operating mine', { permanent: true, direction: 'right'});
