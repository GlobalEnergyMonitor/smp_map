  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([36.007596, 112.9272695], 10)                     
	...
	GEMMine.bindPopup('Zhaozhuang Coal Mine No. 2 Well Operating mine');
	GEMMine.bindTooltip('Zhaozhuang Coal Mine No. 2 Well Operating mine', { permanent: true, direction: 'right'});
