  ...
  "features": [
    {
      ...
      "properties": {
        ...
        "data source date": "2025-11-28 00:00:00",
        ...
        "description": "Vorgashorskaya mine boundary ",
        "coordinates precision": "reported",
        "GEM Mine ID": "M0867",
        "Owners": "Vorkutaugol JSC [100%]",
        "Owners (Non-ENG)": "",
        "Parent Company": "Russkaya Energiya LLC",
        "GEM Wiki Page (ENG)": "https://www.gem.wiki/Vorgashorskaya_mine",
    ...
    },
    {
      ...
      "properties": {
        ...
        "data source date": "2024-08-07 00:00:00",
    ...
    var bounds = L.latLngBounds(L.latLng(67.545656, 63.402708), L.latLng(67.659828, 63.698));                        
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([67.602742, 63.550354], 12)                     
	...
	GEMMine = L.marker([67.5953177, 63.6160208], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Vorgashorskaya Coal Mine Operating mine');
	GEMMine.bindTooltip('Vorgashorskaya Coal Mine Operating mine', { permanent: true, direction: 'right'});
