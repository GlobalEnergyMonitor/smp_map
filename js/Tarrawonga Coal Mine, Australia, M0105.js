  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-30.636891, 150.17201599999999], 10)                     
	...
	GEMMine.bindPopup('Tarrawonga Coal Mine Operating mine');
	GEMMine.bindTooltip('Tarrawonga Coal Mine Operating mine', { permanent: true, direction: 'right'});
