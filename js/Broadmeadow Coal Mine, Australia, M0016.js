  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-21.8251985, 148.0044375], 12.0)                     
	...
	GEMMine.bindTooltip('Broadmeadow Coal Mine', { permanent: true, direction: 'right'});
