  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([36.1709575, 113.0354595], 12.0)                     
	...
	GEMMine.bindTooltip('Sanyuan Coal Mine', { permanent: true, direction: 'right'});
