  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.556458, -81.5943575], 12)                     
	...
	GEMMine.bindPopup('Road Fork 52 Mine Operating mine');
	GEMMine.bindTooltip('Road Fork 52 Mine Operating mine', { permanent: true, direction: 'right'});
