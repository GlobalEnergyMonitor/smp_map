  ...
  "features": [
    ...
    },
    {
      ...
      "properties": {
        ...
        "description": "coal handling and preparation plant in the mine industrial area",
        "coordinates precision": "extracted",
        "GEM Mine ID": "M0087",
        "Owners": "BHP Billiton Mitsubishi Alliance Pty Ltd [100%]",
        "Owners (Non-ENG)": "",
    ...
    var bounds = L.latLngBounds(L.latLng(-22.343119, 148.102584), L.latLng(-22.165084, 148.276516));                        
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-22.2541015, 148.18955], 10)                     
	...
	GEMMine = L.marker([-22.2548999, 148.1796569], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Peak Downs Coal Mine Operating mine');
	GEMMine.bindTooltip('Peak Downs Coal Mine Operating mine', { permanent: true, direction: 'right'});
	GEMMine = L.marker([-22.2548999, 148.1796569], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Peak Downs Coal Mine Proposed mine');
	GEMMine.bindTooltip('Peak Downs Coal Mine Proposed mine', { permanent: true, direction: 'right'});
