  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([33.6461635, 116.6500545], 12.0)                     
	...
	GEMMine.bindTooltip('Linhuan Coal Mine', { permanent: true, direction: 'right'});
