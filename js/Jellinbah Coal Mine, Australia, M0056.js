  ...
  "features": [
    ...
    },
    {
      ...
      "properties": {
        ...
        "data source date": "2023-06-24 00:00:00",
    ...
    var bounds = L.latLngBounds(L.latLng(-23.406874, 148.301091), L.latLng(-22.149696, 148.950644));                        
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-22.778284999999997, 148.62586750000003], 12)                     
	...
	GEMMine = L.marker([-23.406874, 148.950644], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Jellinbah Coal Mine Operating mine');
	GEMMine.bindTooltip('Jellinbah Coal Mine Operating mine', { permanent: true, direction: 'right'});
