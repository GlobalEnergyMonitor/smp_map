  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-22.778284999999997, 148.62586750000003], 12.0)                     
	...
	GEMMine.bindTooltip('Jellinbah Coal Mine', { permanent: true, direction: 'right'});
