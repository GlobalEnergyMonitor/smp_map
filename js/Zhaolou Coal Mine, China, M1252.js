  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([35.40437, 115.88812999999999], 12.0)                     
	...
	GEMMine.bindTooltip('Zhaolou Coal Mine', { permanent: true, direction: 'right'});
