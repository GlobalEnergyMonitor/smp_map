  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-23.662558500000003, 27.539381], 12.0)                     
	...
	GEMMine.bindTooltip('Grootegeluk Coal Mine', { permanent: true, direction: 'right'});
