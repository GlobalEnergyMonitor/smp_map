  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([23.7053155, 86.39344249999999], 10)                     
	...
	GEMMine.bindPopup('Jharia Coal Mine Operating mine');
	GEMMine.bindTooltip('Jharia Coal Mine Operating mine', { permanent: true, direction: 'right'});
