  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-34.3863145, 150.756367], 12.0)                     
	...
	GEMMine.bindTooltip('Dendrobium Coal Mine', { permanent: true, direction: 'right'});
