  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([56.706222, 124.5968665], 12.0)                     
	...
	GEMMine.bindTooltip('Neryungrinsky Coal Mine', { permanent: true, direction: 'right'});
