  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.2418095, -81.631168], 12)                     
	...
	GEMMine.bindPopup('Berwind Coal Mine Operating mine');
	GEMMine.bindTooltip('Berwind Coal Mine Operating mine', { permanent: true, direction: 'right'});
