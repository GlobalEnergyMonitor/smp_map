  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([33.767012, 113.451471], 10)                     
	...
	GEMMine.bindPopup('Tianan No. 8 Coal Mine Operating mine');
	GEMMine.bindTooltip('Tianan No. 8 Coal Mine Operating mine', { permanent: true, direction: 'right'});
