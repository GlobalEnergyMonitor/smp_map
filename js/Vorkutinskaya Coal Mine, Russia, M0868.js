  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([67.51538450000001, 63.963989999999995], 12.0)                     
	...
	GEMMine.bindTooltip('Vorkutinskaya Coal Mine', { permanent: true, direction: 'right'});
