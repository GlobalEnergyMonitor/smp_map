  ...
  "features": [
    {
      ...
      "properties": {
        ...
        "data source date": "2017-12-31 00:00:00",
        "notes": "Boundary coordinates were extracted from the NedraExpert portal for the exploration and production license KEM 01359 TE https://web.archive.org/web/20251106144329/https://www.nedraexpert.ru/subsurface/1144747920/1?ysclid=mhlhi35wr7946674233. The boundary was validated using slide 3 of Stages of development of degassing operations in coal mines, SUEK JSC AO \u201cSUEK-Kuzbass\u201d, ia600407.us.archive.org/31/items/4-2-3-degazaciya-dobycha-i-utilizaciya-metana-ugolnyh-mestorozhdeniy-o/4_2_3_Degazaciya_dobycha_i_utilizaciya_metana_ugolnyh_mestorozhdeniyO.pdf, Oct 31, 2018 (not archivable), which shows the same operational area. The approximate area of the total boundary polygon is 93 sq km.",
        "description": "Kirova Coal Mine boundary",
    ...
    },
    {
      ...
      "properties": {
        ...
        "data source date": "2025-04-12 00:00:00",
        "notes": "Identified visually from Google Earth Pro satellite imagery.",
        "description": "Possible power plant",
        "coordinates precision": "extracted",
        "GEM Mine ID": "M0809",
        "Owners": "SUEK-Kuzbass JSC [100%]",
        "Owners (Non-ENG)": "",
    ...
    },
    {
      ...
      "properties": {
        ...
        "notes": "Identified visually from Google Earth Pro satellite imagery.",
        "description": "Gas drainage station with possible flares",
        "coordinates precision": "extracted",
        "GEM Mine ID": "M0809",
        "Owners": "SUEK-Kuzbass JSC [100%]",
        "Owners (Non-ENG)": "",
    ...
    },
    {
      ...
      "properties": {
        ...
        "data source date": "2021-09-05 00:00:00",
        "notes": "Identified visually from Google Earth Pro satellite imagery.",
        "description": "Possible gas to electric station",
        "coordinates precision": "extracted",
        "GEM Mine ID": "M0809",
        "Owners": "SUEK-Kuzbass JSC [100%]",
        "Owners (Non-ENG)": "",
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([54.6366, 86.14474999999999], 10)                     
	...
	GEMMine.bindPopup('Kirova Coal Mine Operating mine');
	GEMMine.bindTooltip('Kirova Coal Mine Operating mine', { permanent: true, direction: 'right'});
	GEMMine = L.marker([54.652327, 86.152629], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Kirova Coal Mine Shelved mine');
	GEMMine.bindTooltip('Kirova Coal Mine Shelved mine', { permanent: true, direction: 'right'});
