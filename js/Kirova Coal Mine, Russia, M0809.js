  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([54.6366, 86.14474999999999], 12.0)                     
	...
	GEMMine.bindTooltip('Kirova Coal Mine', { permanent: true, direction: 'right'});
