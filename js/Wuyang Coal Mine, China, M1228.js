  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([36.474464, 112.982622], 12.0)                     
	...
	GEMMine.bindTooltip('Wuyang Coal Mine', { permanent: true, direction: 'right'});
