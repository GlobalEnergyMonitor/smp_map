  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([38.2222665, 106.4854785], 12.0)                     
	...
	GEMMine.bindTooltip('Renjiazhuang Coal Mine', { permanent: true, direction: 'right'});
