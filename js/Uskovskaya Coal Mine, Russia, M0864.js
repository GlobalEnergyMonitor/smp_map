  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([54.105925, 87.265418], 12.0)                     
	...
	GEMMine.bindTooltip('Uskovskaya Coal Mine', { permanent: true, direction: 'right'});
