  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([36.140025, 112.92126], 12.0)                     
	...
	GEMMine.bindTooltip('Huoerxinhe Coal Mine', { permanent: true, direction: 'right'});
