  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([35.278238, 115.88263], 12.0)                     
	...
	GEMMine.bindTooltip('Xinjulong Coal Mine', { permanent: true, direction: 'right'});
