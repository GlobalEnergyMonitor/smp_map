  ...
  "features": [
    ...
    var bounds = L.latLngBounds(L.latLng(37.874206, -81.850098), L.latLng(37.950711, -81.772463));                        
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.9124585, -81.81128050000001], 12)                     
	...
	GEMMine = L.marker([37.91, -81.8], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Mountaineer II Coal Mine Operating mine');
	GEMMine.bindTooltip('Mountaineer II Coal Mine Operating mine', { permanent: true, direction: 'right'});
