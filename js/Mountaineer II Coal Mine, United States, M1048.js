  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.9124585, -81.81128050000001], 12.0)                     
	...
	GEMMine.bindTooltip('Mountaineer II Coal Mine', { permanent: true, direction: 'right'});
