  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.2386255, 114.4537535], 12.0)                     
	...
	GEMMine.bindTooltip('Dongpang Coal Mine', { permanent: true, direction: 'right'});
