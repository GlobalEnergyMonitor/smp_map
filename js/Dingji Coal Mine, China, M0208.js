  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([32.8500585, 116.6324475], 12.0)                     
	...
	GEMMine.bindTooltip('Dingji Coal Mine', { permanent: true, direction: 'right'});
