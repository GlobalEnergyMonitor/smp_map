  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([35.831148999999996, 110.7109225], 12.0)                     
	...
	GEMMine.bindTooltip('Wangjialing Coal Mine', { permanent: true, direction: 'right'});
