  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([5.3193525, -73.720429395], 12.0)                     
	...
	GEMMine.bindTooltip('La Ramada Coal Mine', { permanent: true, direction: 'right'});
