  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([33.81567, 113.4074155], 12.0)                     
	...
	GEMMine.bindTooltip('Shoushan No.1 Coal Mine', { permanent: true, direction: 'right'});
