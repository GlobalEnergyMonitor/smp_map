  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.355477, 110.9582925], 12.0)                     
	...
	GEMMine.bindTooltip('Jinjiazhuang Coal Mine', { permanent: true, direction: 'right'});
