  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([53.7788125, 88.0669805], 12.0)                     
	...
	GEMMine.bindTooltip('Raspadskaya Coal Mine', { permanent: true, direction: 'right'});
