  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([40.635016, -79.31756250000001], 12)                     
	...
	GEMMine.bindPopup('Parkwood Coal Mine Operating mine');
	GEMMine.bindTooltip('Parkwood Coal Mine Operating mine', { permanent: true, direction: 'right'});
