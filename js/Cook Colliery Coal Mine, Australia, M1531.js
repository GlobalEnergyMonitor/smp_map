  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-23.726599, 148.91510649999998], 10)                     
	...
	GEMMine.bindPopup('Cook Colliery Coal Mine Operating mine');
	GEMMine.bindTooltip('Cook Colliery Coal Mine Operating mine', { permanent: true, direction: 'right'});
