  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-22.02749823, 148.16784795], 12.0)                     
	...
	GEMMine.bindTooltip('Isaac Downs Coal Mine', { permanent: true, direction: 'right'});
