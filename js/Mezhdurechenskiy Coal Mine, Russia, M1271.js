  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([53.655614, 87.930589], 12.0)                     
	...
	GEMMine.bindTooltip('Mezhdurechenskiy Coal Mine', { permanent: true, direction: 'right'});
