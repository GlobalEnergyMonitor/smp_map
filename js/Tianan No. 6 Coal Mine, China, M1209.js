  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([33.8141415, 113.2449465], 12.0)                     
	...
	GEMMine.bindTooltip('Tianan No. 6 Coal Mine', { permanent: true, direction: 'right'});
