  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([23.774604510000003, 86.484724805], 12.0)                     
	...
	GEMMine.bindTooltip('Block II (BOCP) Coal Mine', { permanent: true, direction: 'right'});
