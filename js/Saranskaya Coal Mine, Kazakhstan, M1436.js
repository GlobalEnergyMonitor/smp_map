  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([49.7581615, 72.89320950000001], 12.0)                     
	...
	GEMMine.bindTooltip('Saranskaya Coal Mine', { permanent: true, direction: 'right'});
