  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.855535, 112.21396], 12.0)                     
	...
	GEMMine.bindTooltip('Dongqu Coal Mine', { permanent: true, direction: 'right'});
