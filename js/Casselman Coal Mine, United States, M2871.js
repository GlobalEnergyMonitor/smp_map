  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([39.669659499999995, -79.1683445], 10)                     
	...
	GEMMine.bindPopup('Casselman Coal Mine Operating mine');
	GEMMine.bindTooltip('Casselman Coal Mine Operating mine', { permanent: true, direction: 'right'});
