  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([11.04634, -72.2676125], 12)                     
	...
	GEMMine.bindPopup('Paso Diablo Coal Mine Operating mine');
	GEMMine.bindTooltip('Paso Diablo Coal Mine Operating mine', { permanent: true, direction: 'right'});
