  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-32.498499499999994, 151.133642], 10)                     
	...
	GEMMine.bindPopup('Rix Creek Coal Mine Operating mine');
	GEMMine.bindTooltip('Rix Creek Coal Mine Operating mine', { permanent: true, direction: 'right'});
	GEMMine = L.marker([-32.52393559, 151.1208768], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Rix Creek Coal Mine Proposed mine');
	GEMMine.bindTooltip('Rix Creek Coal Mine Proposed mine', { permanent: true, direction: 'right'});
