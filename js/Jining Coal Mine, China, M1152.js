  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([35.822325, 110.593642], 12.0)                     
	...
	GEMMine.bindTooltip('Jining Coal Mine', { permanent: true, direction: 'right'});
