  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([23.682053, 86.396917], 12.0)                     
	...
	GEMMine.bindTooltip('Bhowrah (South) Coal Mine', { permanent: true, direction: 'right'});
