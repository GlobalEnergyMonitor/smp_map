  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.693169499999996, 110.8412115], 12.0)                     
	...
	GEMMine.bindTooltip('Shanxi Jinyuan Coal Mine', { permanent: true, direction: 'right'});
