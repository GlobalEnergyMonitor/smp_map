  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([23.800873, 86.2843515], 10)                     
	...
	GEMMine.bindPopup('New Akashkinaree Coal Mine Operating mine');
	GEMMine.bindTooltip('New Akashkinaree Coal Mine Operating mine', { permanent: true, direction: 'right'});
