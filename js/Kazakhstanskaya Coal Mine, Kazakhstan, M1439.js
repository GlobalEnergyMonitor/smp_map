  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([49.7539625, 72.5475635], 10)                     
	...
	GEMMine.bindPopup('Kazakhstanskaya Coal Mine Operating mine');
	GEMMine.bindTooltip('Kazakhstanskaya Coal Mine Operating mine', { permanent: true, direction: 'right'});
