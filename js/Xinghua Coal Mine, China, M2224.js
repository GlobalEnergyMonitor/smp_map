  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([45.325451, 131.109893], 12.0)                     
	...
	GEMMine.bindTooltip('Xinghua Coal Mine', { permanent: true, direction: 'right'});
