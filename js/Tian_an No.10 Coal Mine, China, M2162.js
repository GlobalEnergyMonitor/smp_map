  ...
  "features": [
    {
      ...
      "properties": {
        ...
        "description": "Estimated Tian'an No.10 coal mine boundary",
        "coordinates precision": "estimated",
        "GEM Mine ID": "M2162",
        "Owners": "Pingdingshan Tianan Coal Industry Company Tian'an No.10 Coal Mine [100%]",
        "Owners (Non-ENG)": "",
        "Parent Company": "China Pingmei Shenma Energy and Chemical Group",
        "GEM Wiki Page (ENG)": "https://www.gem.wiki/Tian%27an_No.10_Coal_Mine",
        "GEM Wiki Page (Non-ENG)": "https://www.gem.wiki/%E5%B9%B3%E9%A1%B6%E5%B1%B1%E5%A4%A9%E5%AE%89%E7%85%A4%E4%B8%9A%E8%82%A1%E4%BB%BD%E6%9C%89%E9%99%90%E5%85%AC%E5%8F%B8%E5%8D%81%E7%9F%BF",
        "Coal Grade": "Met",
        "Mine Name": "Tian'an No.10 Coal Mine",
        "Country / Area": "China",
    ...
    var bounds = L.latLngBounds(L.latLng(33.753367, 113.326305), L.latLng(33.814712, 113.396197));                        
    ...
    var map = L.map('map', {layers: [googleHybrid]}).setView([33.7840395, 113.36125100000001], 13.0)                     
    ...
    GEMMine = L.marker([33.759798, 113.349017], {icon: GEMMineIcon}).addTo(map); 
    GEMMine.bindPopup("Operating status(es): Operating");
    GEMMine.bindTooltip("Tian'an No.10 Coal Mine", { permanent: true, direction: 'right'});
