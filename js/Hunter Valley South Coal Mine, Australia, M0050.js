  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-32.540445, 151.01007950000002], 12)                     
	...
	GEMMine.bindPopup('Hunter Valley South Coal Mine Operating mine');
	GEMMine.bindTooltip('Hunter Valley South Coal Mine Operating mine', { permanent: true, direction: 'right'});
