  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([33.3691485, -87.2417725], 12.0)                     
	...
	GEMMine.bindTooltip('No. 7 Coal Mine', { permanent: true, direction: 'right'});
