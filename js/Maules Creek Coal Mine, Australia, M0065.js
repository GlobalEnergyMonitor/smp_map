  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-30.5795645, 150.1060845], 12.0)                     
	...
	GEMMine.bindTooltip('Maules Creek Coal Mine', { permanent: true, direction: 'right'});
