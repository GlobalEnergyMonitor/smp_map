  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([53.7486725, 88.124068], 10)                     
	...
	GEMMine.bindPopup('Raspadskaya Koksovaya Coal Mine Operating mine');
	GEMMine.bindTooltip('Raspadskaya Koksovaya Coal Mine Operating mine', { permanent: true, direction: 'right'});
