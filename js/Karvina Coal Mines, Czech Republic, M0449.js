  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([49.803942500000005, 18.529129], 10)                     
	...
	GEMMine.bindPopup('Karvina Coal Mines Operating mine');
	GEMMine.bindTooltip('Karvina Coal Mines Operating mine', { permanent: true, direction: 'right'});
