  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([67.461007, 63.816140000000004], 12.0)                     
	...
	GEMMine.bindTooltip('Zapolyarnaya Coal Mine', { permanent: true, direction: 'right'});
