  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([40.7843465, -78.73568900000001], 12.0)                     
	...
	GEMMine.bindTooltip('Harmony Coal Mine', { permanent: true, direction: 'right'});
