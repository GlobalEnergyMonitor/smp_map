  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([55.730372, 86.16631949999999], 12.0)                     
	...
	GEMMine.bindTooltip('Pervomayskaya Coal Mine', { permanent: true, direction: 'right'});
