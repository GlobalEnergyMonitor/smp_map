  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-32.443659999999994, 151.0212295], 12.0)                     
	...
	GEMMine.bindTooltip('Ravensworth Coal Mine', { permanent: true, direction: 'right'});
