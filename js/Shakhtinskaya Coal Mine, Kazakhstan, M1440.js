  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([49.764450499999995, 72.627868], 12.0)                     
	...
	GEMMine.bindTooltip('Shakhtinskaya Coal Mine', { permanent: true, direction: 'right'});
