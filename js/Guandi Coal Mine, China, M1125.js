  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.760576, 112.34040300000001], 12.0)                     
	...
	GEMMine.bindTooltip('Guandi Coal Mine', { permanent: true, direction: 'right'});
