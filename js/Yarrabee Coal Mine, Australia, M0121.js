  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-23.3020645, 149.04762399999998], 12.0)                     
	...
	GEMMine.bindTooltip('Yarrabee Coal Mine', { permanent: true, direction: 'right'});
