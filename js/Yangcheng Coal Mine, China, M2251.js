  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([35.7714, 116.351305], 12.0)                     
	...
	GEMMine.bindTooltip('Yangcheng Coal Mine', { permanent: true, direction: 'right'});
