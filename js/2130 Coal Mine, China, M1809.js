  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([43.026804999999996, 87.39246], 12.0)                     
	...
	GEMMine.bindTooltip('2130 Coal Mine', { permanent: true, direction: 'right'});
