  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.831503999999995, 112.05557400000001], 12.0)                     
	...
	GEMMine.bindTooltip('Malan Coal Mine', { permanent: true, direction: 'right'});
