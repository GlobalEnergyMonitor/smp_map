  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.685691000000006, -81.7409715], 12.0)                     
	...
	GEMMine.bindTooltip('Eagle Seam Deep Coal Mine', { permanent: true, direction: 'right'});
