  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([39.914219, 112.9241135], 12.0)                     
	...
	GEMMine.bindTooltip('Datong Wangcun Coal Mine', { permanent: true, direction: 'right'});
