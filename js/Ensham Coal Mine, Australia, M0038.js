  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-23.444463, 148.48899749999998], 10)                     
	...
	GEMMine.bindPopup('Ensham Coal Mine Operating mine');
	GEMMine.bindTooltip('Ensham Coal Mine Operating mine', { permanent: true, direction: 'right'});
	GEMMine = L.marker([-23.454464, 148.497455], {icon: GEMMineIcon}).addTo(map); 
	GEMMine.bindPopup('Ensham Coal Mine Proposed mine');
	GEMMine.bindTooltip('Ensham Coal Mine Proposed mine', { permanent: true, direction: 'right'});
