  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([-41.6719305, 171.87118650000002], 12.0)                     
	...
	GEMMine.bindTooltip('Stockton Coal Mine', { permanent: true, direction: 'right'});
