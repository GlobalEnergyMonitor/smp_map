  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([49.692923500000006, 72.76835650000001], 12.0)                     
	...
	GEMMine.bindTooltip('Abayskaya Coal Mine', { permanent: true, direction: 'right'});
