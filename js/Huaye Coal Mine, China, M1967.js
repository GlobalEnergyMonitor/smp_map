  ...
  "features": [
    ...
    var map = L.map('map', {layers: [googleStreet, googleHybrid]}).setView([37.652054, 110.8878105], 10)                     
	...
	GEMMine.bindPopup('Huaye Coal Mine Operating mine');
	GEMMine.bindTooltip('Huaye Coal Mine Operating mine', { permanent: true, direction: 'right'});
